...
const defaultHomeReviews: Testimonial[] = [
  {
    ...
    name: 'Sumaiya R.',
    city: 'Delhi',
    quote: "The fabric quality is unlike anything I've ordered online before. My abaya drapes beautifully and the stitching is flawless.",
    initials: 'SR',
    product: 'Double Layer Premium Abaya',
    rating: 5,
    is_active: true,
  ...
  },
  {
    ...
    name: 'Afreen K.',
    city: 'Noida',
    quote: "Hijabista understands modest fashion doesn't mean boring. Loved the colour options and how fast it reached me.",
    initials: 'AK',
    product: 'Double Layer Premium Abaya',
    rating: 5,
    is_active: true,
  ...
  },
  {
    ...
    name: 'Hina M.',
    city: 'Gurugram',
    quote: "I messaged on WhatsApp for sizing help and got a reply within minutes. The dress fit perfectly on the first try.",
    initials: 'HM',
    product: 'Double Layer Premium Abaya',
    rating: 5,
    is_active: true,
  ...
  },
  {
    ...
    name: 'Zoya A.',
    city: 'Faridabad',
    quote: "Ordered three hijabs for Eid and each one felt premium. Definitely my go-to store for modest essentials now.",
    initials: 'ZA',
    product: 'Double Layer Premium Abaya',
    rating: 5,
    is_active: true,

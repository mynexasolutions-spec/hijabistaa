...
export default function ProductGallery({ images, productName, badge }: ProductGalleryProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
      ...
      {/* Main Image */}
      <div 
        className="order-1 md:order-2 relative w-full aspect-[16/19] rounded-[32px] overflow-hidden shadow-soft border border-gold/15 bg-cream-deep cursor-crosshair"

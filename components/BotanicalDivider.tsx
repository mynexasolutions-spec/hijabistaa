...
export default function BotanicalDivider({
  ...
  return (
    <div
      className="w-full flex items-center justify-center px-5 py-2.5 md:py-4 md:px-5"
      aria-hidden="true"
    >
      <svg
        ref={ref}
        viewBox="0 0 600 60"
        className={`w-full max-w-[240px] sm:max-w-[340px] md:max-w-[420px] h-8 sm:h-10 md:h-12 mx-auto ${flip ? "scale-x-[-1]" : ""}`}
        fill="none"

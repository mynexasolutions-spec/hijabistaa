            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  name="question"
                  className="mt-1 block w-full rounded-md border-0 px-5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  required
                />
              </div>
              <div>

        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 lg:gap-5 order-2 lg:order-1 w-full h-[450px] md:h-[550px] lg:h-[600px]">
            <div className="flex flex-col gap-3 md:gap-4 lg:gap-5 h-full">
              <div className="relative w-full flex-grow rounded-[20px] md:rounded-[28px] overflow-hidden shadow-soft border border-gold/20 group">
                <Image src="/assets/images/img_05.webp" alt="The Luxury Hijab & Scarf Edit 1" fill sizes="(max-width: 1024px) 50vw, 300px" className="object-cover object-center transition-all duration-700 group-hover:scale-[1.05]" />
              </div>
              <div className="relative w-full h-[35%] rounded-[20px] md:rounded-[28px] overflow-hidden shadow-soft border border-gold/20 group">
                <Image src="/assets/images/img_02.webp" alt="The Luxury Hijab & Scarf Edit 2" fill sizes="(max-width: 1024px) 50vw, 300px" className="object-cover object-top transition-all duration-700 group-hover:scale-[1.05]" />
              </div>
            </div>
            <div className="flex flex-col gap-3 md:gap-4 lg:gap-5 h-full pt-8 md:pt-12">
              <div className="relative w-full h-[40%] rounded-[20px] md:rounded-[28px] overflow-hidden shadow-soft border border-gold/20 group">
                <Image src="/assets/images/img_03.jpg" alt="The Luxury Hijab & Scarf Edit 3" fill sizes="(max-width: 1024px) 50vw, 300px" className="object-cover object-center transition-all duration-700 group-hover:scale-[1.05]" />
              </div>
              <div className="relative w-full flex-grow rounded-[20px] md:rounded-[28px] overflow-hidden shadow-soft border border-gold/20 group">
                <Image src="/assets/images/img_04.webp" alt="The Luxury Hijab & Scarf Edit 4" fill sizes="(max-width: 1024px) 50vw, 300px" className="object-cover object-top transition-all duration-700 group-hover:scale-[1.05]" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center py-4 lg:py-6 justify-center order-1 lg:order-2">
            ...
            <h2 className="mt-4 font-display font-bold text-4xl md:text-5xl text-ink leading-tight">
              The <span className="italic text-gold font-medium">Signature</span> Hijab Collection
            </h2>
